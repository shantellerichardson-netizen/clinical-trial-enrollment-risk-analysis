...
**Data Source:**
Public clinical trail dataset from Kaggle, https://www.kaggle.com/datasets/irakozekelly/pharmaceutical-r-and-d-clinical-trial-data-overview?resource=download 
- The dataset contains approximately 13,700+ records used to analyze enrollment risk patterns and portfolio-level operational trends in clincal trial management.
